...
class _MessageCardState extends State<MessageCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
        ...
        child: isMe ? _buildMessage(Colors.grey[200], Alignment.centerRight, Colors.blue)
            : _buildMessage(Colors.blue[100], Alignment.centerLeft, Colors.grey));
  }

  Widget _buildMessage(Color? bgColor, Alignment alignment, Color seenIconColor) {
